...
const PLANS = [
  {
    ...
    features: [
      "5 lượt phân tích CV & JD",
      "1 phiên AI Interview trải nghiệm (3 câu hỏi)",
      "Cá nhân hóa theo vị trí ứng tuyển",
  ...
  },
  {
    ...
    features: [
      "40 lượt phân tích CV/JD",
      "8 phiên AI Interview nâng cao (5 câu hỏi/phiên)",
      "Điều chỉnh theo mức độ kinh nghiệm",
      "Gợi ý câu hỏi phỏng vấn dựa trên JD",
      "Phản hồi chi tiết sau mỗi phiên",
      "Lưu lịch sử phỏng vấn",
      "Theo dõi tiến độ qua nhiều phiên phỏng vấn",
    ],
    cta: "Nâng cấp Elite",
    popular: true,
    variant: "elite",
